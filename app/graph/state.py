...
class State(TypedDict):
    ...
    Fields:
        ...
        customer_tier: Customer classification - "standard" or "premium".
                      Determined by Bouncer Agent from Account.premium field.
                      Set by the Bouncer Agent.
        customer_intent: Classified customer intent from conversation history, such as
                        "account_balance", "transaction_history", "fund_transfer",
                        "lost_card", or "general_inquiry". Set by the Bouncer Agent.
...
def create_initial_state(session_id: str) -> State:
    ...
    Returns:
        ...
        - customer_intent: None (not classified yet)
